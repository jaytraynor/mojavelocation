...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    $("#foot").innerHTML = "Photos: Street View loads automatically; add up to 3 of your own per place in data.js. Use the region tabs, area buttons, and “Show” to filter by scene.";
  });
})();
